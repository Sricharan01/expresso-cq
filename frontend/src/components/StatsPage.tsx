...
// import { LineChart, Line, XAxis, YAxis, ResponsiveContainer, Radar, RadarChart, PolarGrid, PolarAngleAxis, PolarRadiusAxis } from "recharts";
...
//   const monthlyData = [
//     { day: "Week 1", wellness: 70 },
//     { day: "Week 2", wellness: 75 },
//     { day: "Week 3", wellness: 78 },
//     { day: "Week 4", wellness: 82 }
//   ];
...
//     { emotion: "Calm", value: 72 },
//     { emotion: "Anxious", value: 35 },
//     { emotion: "Energetic", value: 78 },
//     { emotion: "Sad", value: 25 },
//     { emotion: "Confident", value: 80 }
//   ];
...
//               <div className="text-gray-600 text-xs mb-1">Total Check-ins</div>
//               <div className="text-2xl">47</div>
//             </div>

//             <div className="bg-white border border-gray-200 rounded-lg p-3 text-center flex flex-col justify-center">
//               <div className="text-gray-600 text-xs mb-1">Current Streak</div>
//               <div className="text-2xl">12 days</div>
//             </div>

//             <div className="bg-white border border-gray-200 rounded-lg p-3 text-center flex flex-col justify-center">
//               <div className="text-gray-600 text-xs mb-1">Wellness Score</div>
//               <div className="text-2xl">82</div>
//             </div>
//           </div>

//           {/* Bottom Row - Two containers side by side */}
//           <div className="grid grid-cols-5 gap-4 h-[calc(100%-9rem)]">
//             {/* Left container - Wide rectangle (takes 3/5 of width) */}
//             <div className="col-span-3 bg-white border border-gray-200 rounded-lg p-4">
//               <div className="flex justify-between items-center mb-4">
//                 <div className="text-gray-600">Wellness Trends</div>
//                 <Select value={selectedPeriod} onValueChange={setSelectedPeriod}>
//                   <SelectTrigger className="w-20 h-8 text-xs border border-gray-300">
//                     <SelectValue />
//                   </SelectTrigger>
//                   <SelectContent>
...
//                       strokeWidth={3}
//                       dot={{ fill: selectedColor, strokeWidth: 0, r: 4 }}
...
//             {/* Right container - Tall rectangle (takes 2/5 of width) */}
//             <div className="col-span-2 bg-white border border-gray-200 rounded-lg p-4">
//               <div className="text-gray-600 text-xs mb-4 text-center">Emotion Web</div>
